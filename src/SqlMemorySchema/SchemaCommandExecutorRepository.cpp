...
**
****************************************************************************/
#include "SchemaCommandExecutorRepository.h"

namespace QSqlMigrator {
namespace SqlMemorySchema {

void
SchemaCommandExecutorRepository::add(CommandExecutor commandExecutor)
{
    if (!commandExecutor)
...
SchemaCommandExecutorRepository::CommandExecutor
SchemaCommandExecutorRepository::findExecutor(const CommandName &commandName) const
{
