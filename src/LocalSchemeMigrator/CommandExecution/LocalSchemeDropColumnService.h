...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_LOCALSCHEMEDROPCOLUMNSERVICE_H
#define COMMANDEXECUTION_LOCALSCHEMEDROPCOLUMNSERVICE_H

#include "CommandExecution/LocalSchemeBaseCommandExecutionService.h"

namespace CommandExecution {

class QSQLMIGRATOR_DLL_EXPORT LocalSchemeDropColumnService : public LocalSchemeBaseCommandExecutionService
{
public:
    LocalSchemeDropColumnService();
...
#endif // COMMANDEXECUTION_LOCALSCHEMEDROPCOLUMNSERVICE_H
