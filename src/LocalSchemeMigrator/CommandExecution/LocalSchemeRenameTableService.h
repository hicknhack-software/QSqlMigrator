...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_LOCALSCHEMERENAMETABLESERVICE_H
#define COMMANDEXECUTION_LOCALSCHEMERENAMETABLESERVICE_H

#include "CommandExecution/LocalSchemeBaseCommandExecutionService.h"

namespace CommandExecution {

class QSQLMIGRATOR_DLL_EXPORT LocalSchemeRenameTableService : public LocalSchemeBaseCommandExecutionService
{
public:
    LocalSchemeRenameTableService();
...
#endif // COMMANDEXECUTION_LOCALSCHEMERENAMETABLESERVICE_H
