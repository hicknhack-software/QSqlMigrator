...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_LOCALSCHEMECREATETABLESERVICE_H
#define COMMANDEXECUTION_LOCALSCHEMECREATETABLESERVICE_H

#include "CommandExecution/LocalSchemeBaseCommandExecutionService.h"

namespace CommandExecution {

class QSQLMIGRATOR_DLL_EXPORT LocalSchemeCreateTableService : public LocalSchemeBaseCommandExecutionService
{
public:
    LocalSchemeCreateTableService();
...
#endif // COMMANDEXECUTION_LOCALSCHEMECREATETABLESERVICE_H
