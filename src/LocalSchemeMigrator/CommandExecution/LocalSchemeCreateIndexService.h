...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_LOCALSCHEMECREATEINDEXSERVICE_H
#define COMMANDEXECUTION_LOCALSCHEMECREATEINDEXSERVICE_H

#include "CommandExecution/LocalSchemeBaseCommandExecutionService.h"

namespace CommandExecution {

class QSQLMIGRATOR_DLL_EXPORT LocalSchemeCreateIndexService : public LocalSchemeBaseCommandExecutionService
{
public:
    LocalSchemeCreateIndexService();
...
#endif // COMMANDEXECUTION_LOCALSCHEMECREATEINDEXSERVICE_H
