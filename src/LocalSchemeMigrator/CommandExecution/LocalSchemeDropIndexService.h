...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_LOCALSCHEMEDROPINDEXSERVICE_H
#define COMMANDEXECUTION_LOCALSCHEMEDROPINDEXSERVICE_H

#include "CommandExecution/LocalSchemeBaseCommandExecutionService.h"

namespace CommandExecution {

class QSQLMIGRATOR_DLL_EXPORT LocalSchemeDropIndexService : public LocalSchemeBaseCommandExecutionService
{
public:
    LocalSchemeDropIndexService();
...
#endif // COMMANDEXECUTION_LOCALSCHEMEDROPINDEXSERVICE_H
