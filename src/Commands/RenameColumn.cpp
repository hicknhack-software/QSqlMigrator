...
{
    if(name.isEmpty()) {
        ::qWarning() << LOG_PREFIX << RenameColumn::typeName() << "command with empty name!";
    }

    if(newName.isEmpty()) {
        ::qWarning() << LOG_PREFIX << RenameColumn::typeName() << "command" << name << "with empty newName!";
    }

    if(tableName.isEmpty()) {
        ::qWarning() << LOG_PREFIX << RenameColumn::typeName() << "command" << name << "with empty tableName!";
    }
}
