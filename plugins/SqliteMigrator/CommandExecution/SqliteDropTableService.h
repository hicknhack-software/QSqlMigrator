...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_SQLITEDROPTABLESERVICE_H
#define COMMANDEXECUTION_SQLITEDROPTABLESERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class SqliteDropTableService : public CommandExecution::BaseCommandExecutionService
{
public:
    SqliteDropTableService();
...
#endif // COMMANDEXECUTION_SQLITEDROPTABLESERVICE_H
