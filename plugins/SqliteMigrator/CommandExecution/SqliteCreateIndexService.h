...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_SQLITECREATEINDEXSERVICE_H
#define COMMANDEXECUTION_SQLITECREATEINDEXSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class SqliteCreateIndexService : public CommandExecution::BaseCommandExecutionService
{
public:
    SqliteCreateIndexService();
...
#endif // COMMANDEXECUTION_SQLITECREATEINDEXSERVICE_H
