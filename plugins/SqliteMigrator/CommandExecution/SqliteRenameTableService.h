...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_SQLITERENAMETABLESERVICE_H
#define COMMANDEXECUTION_SQLITERENAMETABLESERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class SqliteRenameTableService : public CommandExecution::BaseCommandExecutionService
{
public:
    SqliteRenameTableService();
...
#endif // COMMANDEXECUTION_SQLITERENAMETABLESERVICE_H
