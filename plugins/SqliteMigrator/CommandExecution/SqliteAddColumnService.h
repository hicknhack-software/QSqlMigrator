...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_SQLITEADDCOLUMNSERVICE_H
#define COMMANDEXECUTION_SQLITEADDCOLUMNSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class SqliteAddColumnService : public CommandExecution::BaseCommandExecutionService
{
public:
    SqliteAddColumnService();
...
#endif // COMMANDEXECUTION_SQLITEADDCOLUMNSERVICE_H
