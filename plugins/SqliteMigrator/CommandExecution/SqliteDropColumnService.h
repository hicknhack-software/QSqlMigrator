...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_SQLITEDROPCOLUMNSERVICE_H
#define COMMANDEXECUTION_SQLITEDROPCOLUMNSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class SqliteDropColumnService : public CommandExecution::BaseCommandExecutionService
{
public:
...
#endif // COMMANDEXECUTION_SQLITEDROPCOLUMNSERVICE_H
