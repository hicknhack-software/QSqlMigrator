...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_MYSQLDROPCOLUMNSERVICE_H
#define COMMANDEXECUTION_MYSQLDROPCOLUMNSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class MysqlDropColumnService : public CommandExecution::BaseCommandExecutionService
{
public:
    MysqlDropColumnService();
...
#endif // COMMANDEXECUTION_MYSQLDROPCOLUMNSERVICE_H
