...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_MYSQLADDCOLUMNSERVICE_H
#define COMMANDEXECUTION_MYSQLADDCOLUMNSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class MysqlAddColumnService : public CommandExecution::BaseCommandExecutionService
{
public:
    MysqlAddColumnService();
...
#endif // COMMANDEXECUTION_MYSQLADDCOLUMNSERVICE_H
