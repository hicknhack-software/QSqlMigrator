...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_MYSQLCREATEINDEXSERVICE_H
#define COMMANDEXECUTION_MYSQLCREATEINDEXSERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class MysqlCreateIndexService : public CommandExecution::BaseCommandExecutionService
{
public:
    MysqlCreateIndexService();

    const QString &commandType() const;

    //INFO: modify up() and down() not to be const, if it is necessary to put UndoCommands into the context
...
#endif // COMMANDEXECUTION_MYSQLCREATEINDEXSERVICE_H
