...
**
****************************************************************************/
#ifndef COMMANDEXECUTION_MYSQLRENAMETABLESERVICE_H
#define COMMANDEXECUTION_MYSQLRENAMETABLESERVICE_H

#include "CommandExecution/BaseCommandExecutionService.h"

namespace CommandExecution {

class MysqlRenameTableService : public CommandExecution::BaseCommandExecutionService
{
public:
    MysqlRenameTableService();
...
#endif // COMMANDEXECUTION_MYSQLRENAMETABLESERVICE_H
